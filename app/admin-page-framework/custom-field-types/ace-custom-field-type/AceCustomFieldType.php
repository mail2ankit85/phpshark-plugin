<?php
/**
 * PHPShark_AceCustomFieldType, for the  Admin Page Framework by Michael Uno, is written by Per Soderlind - http://soderlind.no
 */
if ( ! class_exists( 'PHPShark_AceCustomFieldType' ) ) :
class PHPShark_AceCustomFieldType extends PHPShark_AdminPageFramework_FieldType {
            ...
            jQuery().registerAPFCallback( {
                ...
                */
                added_repeatable_field: function( oCopied, sFieldType, sFieldTagID, iCallType ) {
                    ...
                    oCopied.closest( '.phpshark-plugin-field' ).nextAll().andSelf().each( function( iIndex ) {
