<?php
if ( ! class_exists( 'PHPShark_GitHubCustomFieldType' ) ) :
/**
 * @version     1.0.1
 */
class PHPShark_GitHubCustomFieldType extends PHPShark_AdminPageFramework_FieldType {
    ...
    protected function getField( $aField ) { 
        ...
        return 
            $aField['before_label']
            . "<div class='phpshark-plugin-input-label-container'>"        
                . $aField['before_input']
                . ( $aField['label'] && ! $aField['repeatable']
                    ? "<span class='phpshark-plugin-input-label-string' style='min-width:" . $this->getLengthSanitized( $aField['label_min_width'] ) . ";'>" . $aField['label'] . "</span>"
                    : "" 
                )
        ...
        private function _getButtonLabelByType( $sButtonType, $sUserName, $sValue ) {
            ...
            switch( $sButtonType ) {
                case 'follow': 
                    return sprintf( __( 'Follow @%1$s', 'phpshark-plugin' ), $sUserName );
                case 'watch':
                    return __( 'Watch', 'phpshark-plugin' );
                case 'star':
                    return __( 'Star', 'phpshark-plugin' );
                case 'fork':
                    return __( 'Fork', 'phpshark-plugin' );
                case 'issue':
                    return __( 'Issue', 'phpshark-plugin' );
                default:
                    return '';
            }                 
