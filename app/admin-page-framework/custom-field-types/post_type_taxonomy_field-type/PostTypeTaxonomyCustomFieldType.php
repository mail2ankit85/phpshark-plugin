 ...
 * @package     PHPShark_AdminPageFramework
 */

if ( ! class_exists( 'PHPShark_PostTypeTaxonomyCustomFieldType' ) ) :
/**
 ...
 */
class PHPShark_PostTypeTaxonomyCustomFieldType extends PHPShark_AdminPageFramework_FieldType_taxonomy {
...
jQuery( document ).ready( function(){
    ...
    jQuery( '.phpshark-plugin-checkbox-container-posttype[data-select_all_button]' ).each( function( iIndex ){
        jQuery( this ).before( '<div class=\"select_all_button_container\" onclick=\"jQuery( this ).selectAllPHPShark_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_all_button' ) + '</a></div>' );
    });            
    jQuery( '.phpshark-plugin-checkbox-container-posttype[data-select_none_button]' ).each( function( iIndex ){
        jQuery( this ).before( '<div class=\"select_none_button_container\" onclick=\"jQuery( this ).deselectAllPHPShark_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_none_button' ) + '</a></div>' );
    });
    
    // When the post type check-boxes are clicked, show/hide the corresponding taxonomy elements.
    jQuery( document ).on( 'change', '.phpshark-plugin-field-post_type_taxonomy .phpshark-plugin-field-posttype input[type="checkbox"]', function() {
        ...
        var _oField              = jQuery( this ).closest( '.phpshark-plugin-field-post_type_taxonomy' );
    ...
    jQuery( '.phpshark-plugin-field-post_type_taxonomy .phpshark-plugin-field-posttype input[type="checkbox"]:not(:checked)' ).each( function(){
        jQuery( this ).trigger( 'change' );
    } );
    

    jQuery().registerPHPShark_AdminPageFrameworkCallbacks( {
        /**
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            oCloned.find( '.phpshark-plugin-field-posttype input[type="checkbox"]' )
                .prop( 'checked', false )
                .trigger( 'change' );         
...
.phpshark-plugin-field-post_type_taxonomy .select_all_button_container, 
.phpshark-plugin-field-post_type_taxonomy .select_none_button_container
{
...
.phpshark-plugin-field-post_type_taxonomy .select-taxonomy-terms-checkbox-container {
            ...
            return "<div class='select-taxonomy-terms-checkbox-container'>"
                    . "<label class='select-taxonomy-terms'>"
                        ...
                        . "<input " . $this->getAttributes( $_aCheckboxAttributes ) . " />"
                            . __( 'Select taxonomy terms.', 'phpshark-plugin-loader' )
                    . "</label>"
                . "</div>";
