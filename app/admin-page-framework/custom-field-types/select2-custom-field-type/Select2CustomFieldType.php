...
if ( ! class_exists( 'PHPShark_Select2CustomFieldType' ) ) :
/**
 ...
 */
class PHPShark_Select2CustomFieldType extends PHPShark_AdminPageFramework_FieldType_select {
...
"jQuery( document ).ready( function(){
    ...
    var _initializeSelect2 = function( oNode ) {
        ...
        if ( _aOptions[ 'width' ] && 'auto' !== _aOptions[ 'width' ] ) {
            var _oFieldContainer = _oSelect2Target.closest( '.phpshark-plugin-field-select2' );
            _oFieldContainer.css( 'width', _aOptions[ 'width' ] );
            _oFieldContainer.children( '.phpshark-plugin-select-label' )
                .css( 'width', '100%' );
            _oFieldContainer.children( '.phpshark-plugin-select-label' )
                .children( 'label' )
                .children( '.phpshark-plugin-input-container' )
                .css( 'width', '100%' );
            _aOptions[ 'width' ] = '100%';
        }
        ...
        if ( _aOptions[ 'search_callback' ] ) {
             ...
             * Set initial values.
             */
            var _oInputForEncoded = _oSelect2Target.closest( '.phpshark-plugin-field' )
            ...
            _oSelect2Target.on( 'change', function( event ){
                ...
                jQuery( this ).closest( '.phpshark-plugin-field' )
                    .children( 'input[data-encoded]' ).first()
    ...
    protected function getStyles() {
        return "
.phpshark-plugin-field-select2 .select2-container {     
    min-width: 200px;
    width: auto;
}

.phpshark-plugin-field-select2 {
    max-width: 96%;
}

/* Make a room for repeatable buttons */
.repeatable .phpshark-plugin-field-select2 > .phpshark-plugin-select-label > label > .phpshark-plugin-input-container {
    max-width: 84%;
}
