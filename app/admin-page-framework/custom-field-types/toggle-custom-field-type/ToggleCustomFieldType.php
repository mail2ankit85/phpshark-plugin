...
if ( ! class_exists( 'PHPShark_ToggleCustomFieldType' ) ) :
/**
 ...
 */
class PHPShark_ToggleCustomFieldType extends PHPShark_AdminPageFramework_FieldType_checkbox {
        ...
        return "jQuery( document ).ready( function(){
            ...
            jQuery( '.switch_toggle_buttons' ).each( function () {
                ...
                jQuery( this ).closest( '.phpshark-plugin-field' )
                    .children( '.phpshark-plugin-checkbox-container-toggle' )
                    .hide();
