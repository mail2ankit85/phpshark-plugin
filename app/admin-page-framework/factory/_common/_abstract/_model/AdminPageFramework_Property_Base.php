...
abstract class PHPShark_AdminPageFramework_Property_Base extends PHPShark_AdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'phpshark-plugin' : $sTextDomain;
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['aPHPShark_AdminPageFramework'])) {
            $GLOBALS['aPHPShark_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => PHPShark_AdminPageFramework_Registry::NAME, 'sURI' => PHPShark_AdminPageFramework_Registry::URI, 'sScriptName' => PHPShark_AdminPageFramework_Registry::NAME, 'sLibraryName' => PHPShark_AdminPageFramework_Registry::NAME, 'sLibraryURI' => PHPShark_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => PHPShark_AdminPageFramework_Registry::getVersion(), 'sDescription' => PHPShark_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => PHPShark_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => PHPShark_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => PHPShark_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => PHPShark_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new PHPShark_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
    }
