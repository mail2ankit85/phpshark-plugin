...
class PHPShark_AdminPageFramework_Form_Model___SetFieldResources extends PHPShark_AdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new PHPShark_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('PHPShark_AdminPageFramework_Form_View___CSS_Form', 'PHPShark_AdminPageFramework_Form_View___CSS_Field', 'PHPShark_AdminPageFramework_Form_View___CSS_Section', 'PHPShark_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'PHPShark_AdminPageFramework_Form_View___CSS_FieldError', 'PHPShark_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('PHPShark_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition) {
        ...
        new PHPShark_AdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new PHPShark_AdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
