...
class PHPShark_AdminPageFramework_Form_Model___Format_RepeatableSection extends PHPShark_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : PHPShark_AdminPageFramework_Message::getInstance();
    }
    public function get() {
    ...
    class PHPShark_AdminPageFramework_Form_Model___Format_RepeatableField extends PHPShark_AdminPageFramework_Form_Model___Format_RepeatableSection {
        protected function _getDefaultMessage() {
