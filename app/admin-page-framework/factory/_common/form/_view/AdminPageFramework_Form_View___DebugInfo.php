...
class PHPShark_AdminPageFramework_Form_View___DebugInfo extends PHPShark_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='phpshark-plugin-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
