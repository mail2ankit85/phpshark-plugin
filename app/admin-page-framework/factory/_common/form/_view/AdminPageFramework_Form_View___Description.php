...
class PHPShark_AdminPageFramework_Form_View___Description extends PHPShark_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'phpshark-plugin-form-element-description';
