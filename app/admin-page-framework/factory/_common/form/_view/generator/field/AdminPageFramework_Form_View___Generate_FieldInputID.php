...
class PHPShark_AdminPageFramework_Form_View___Generate_FieldTagID extends PHPShark_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
    ...
    class PHPShark_AdminPageFramework_Form_View___Generate_FieldInputID extends PHPShark_AdminPageFramework_Form_View___Generate_FieldTagID {
        public $isIndex = '';
