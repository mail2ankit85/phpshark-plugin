...
class PHPShark_AdminPageFramework_Form_View___Script_CheckboxSelector extends PHPShark_AdminPageFramework_Form_View___Script_Base {
...
(function ( $ ) {
     ...
     */        
    $.fn.selectAllPHPShark_AdminPageFrameworkCheckboxes = function() {
        jQuery( this ).parent()
     ...
     */
    $.fn.deselectAllPHPShark_AdminPageFrameworkCheckboxes = function() {
        jQuery( this ).parent()
            .find( 'input[type=checkbox]' )
            .attr( 'checked', false )
            .trigger( 'change' );   // 3.8.8+
