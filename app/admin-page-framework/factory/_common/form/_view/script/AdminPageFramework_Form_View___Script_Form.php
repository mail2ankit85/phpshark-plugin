...
class PHPShark_AdminPageFramework_Form_View___Script_Form extends PHPShark_AdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
( function( $ ) {

    var _removePHPShark_AdminPageFrameworkLoadingOutputs = function() {

        jQuery( '.phpshark-plugin-form-loading' ).remove();
        jQuery( '.phpshark-plugin-form-js-on' )
            .hide()
            .css( 'visibility', 'visible' )
            .fadeIn( 200 )
            .removeClass( '.phpshark-plugin-form-js-on' );
    ...
    window.onerror = function(){
        ...
        _removePHPShark_AdminPageFrameworkLoadingOutputs();
