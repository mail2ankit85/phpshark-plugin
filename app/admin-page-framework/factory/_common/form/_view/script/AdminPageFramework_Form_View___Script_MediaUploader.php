...
class PHPShark_AdminPageFramework_Form_View___Script_MediaUploader extends PHPShark_AdminPageFramework_Form_View___Script_Base {
...
(function ( $ ) {
    ...
    getPHPShark_AdminPageFrameworkCustomMediaUploaderSelectObject = function() {
