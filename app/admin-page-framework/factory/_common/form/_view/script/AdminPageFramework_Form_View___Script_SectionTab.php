...
class PHPShark_AdminPageFramework_Form_View___Script_SectionTab extends PHPShark_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.phpshark-plugin-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='phpshark-plugin-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
    }
