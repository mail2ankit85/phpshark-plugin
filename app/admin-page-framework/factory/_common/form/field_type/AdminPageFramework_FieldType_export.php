...
class PHPShark_AdminPageFramework_FieldType_submit extends PHPShark_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".phpshark-plugin-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'phpshark-plugin-input-label-container' . ' phpshark-plugin-input-button-container' . ' phpshark-plugin-input-container',);
    }
    ...
    class PHPShark_AdminPageFramework_FieldType_export extends PHPShark_AdminPageFramework_FieldType_submit {
