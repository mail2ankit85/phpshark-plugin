...
class PHPShark_AdminPageFramework_FieldType_import extends PHPShark_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".phpshark-plugin-field-import input {margin-right: 0.5em;}.phpshark-plugin-field-import label,.form-table td fieldset.phpshark-plugin-fieldset .phpshark-plugin-field-import label { display: inline; }";
    }
