...
class PHPShark_AdminPageFramework_FieldType_checkbox extends PHPShark_AdminPageFramework_FieldType {
...
JAVASCRIPTS;
    ...
    private function _getSelectButtonClassSelectors(array $aFieldTypeSlugs, $sDataAttribute = 'select_all_button') {
        ...
        foreach ($aFieldTypeSlugs as $_sSlug) {
            ...
            $_aClassSelectors[] = '.phpshark-plugin-checkbox-container-' . $_sSlug . "[data-{$sDataAttribute}]";
        }
        return implode(',', $_aClassSelectors);
    }
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.phpshark-plugin-checkbox-label {margin-top: 0.1em;}.phpshark-plugin-field input[type='checkbox' ] {margin-right: 0.5em;} .phpshark-plugin-field-checkbox .phpshark-plugin-input-label-container {padding-right: 1em;}.phpshark-plugin-field-checkbox .phpshark-plugin-input-label-string{display: inline; }";
    }
    ...
    class PHPShark_AdminPageFramework_FieldType_posttype extends PHPShark_AdminPageFramework_FieldType_checkbox {
        ...
        protected function getStyles() {
            ...
            return $_sParentStyles . ".phpshark-plugin-field input[type='checkbox'] {margin-right: 0.5em;} .phpshark-plugin-field-posttype .phpshark-plugin-input-label-container {padding-right: 1em;}";
        }
        protected function getField($aField) {
