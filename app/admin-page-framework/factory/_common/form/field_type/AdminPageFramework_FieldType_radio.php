...
class PHPShark_AdminPageFramework_FieldType_radio extends PHPShark_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".phpshark-plugin-field input[type='radio'] {margin-right: 0.5em;} .phpshark-plugin-field-radio .phpshark-plugin-input-label-container {padding-right: 1em;} .phpshark-plugin-field-radio .phpshark-plugin-input-container {display: inline;} .phpshark-plugin-field-radio .phpshark-plugin-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.phpshark-plugin-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
