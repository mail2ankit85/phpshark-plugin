...
class PHPShark_AdminPageFramework_FieldType_section_title extends PHPShark_AdminPageFramework_FieldType_text {
    ...
    protected function getStyles() {
        return ".phpshark-plugin-section-tab .phpshark-plugin-field-section_title {padding: 0.5em;} .phpshark-plugin-section-tab .phpshark-plugin-field-section_title .phpshark-plugin-input-label-string { vertical-align: middle; margin-left: 0.2em;}.phpshark-plugin-section-tab .phpshark-plugin-fields {display: inline-block;} .phpshark-plugin-field.phpshark-plugin-field-section_title {float: none;} .phpshark-plugin-field.phpshark-plugin-field-section_title input {background-color: #fff;color: #333;border-color: #ddd;box-shadow: inset 0 1px 2px rgba(0,0,0,.07);border-width: 1px;border-style: solid;outline: 0;box-sizing: border-box;vertical-align: middle;}";
    }
