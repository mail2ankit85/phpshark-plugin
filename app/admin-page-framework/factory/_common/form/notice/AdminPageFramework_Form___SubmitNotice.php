...
class PHPShark_AdminPageFramework_Form___SubmitNotice extends PHPShark_AdminPageFramework_FrameworkUtility {
    ...
    public function render() {
        new PHPShark_AdminPageFramework_AdminNotice('');
    ...
    private function _printNotices($aNotices) {
        ...
        foreach (array_filter(( array )$aNotices, 'is_array') as $_aNotice) {
            ...
            new PHPShark_AdminPageFramework_AdminNotice($this->getElement($_aNotice, 'sMessage'), $this->getElement($_aNotice, 'aAttributes'));
        }
    }
    }
