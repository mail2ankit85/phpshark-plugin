...
class PHPShark_AdminPageFramework_FrameworkUtility extends PHPShark_AdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = PHPShark_AdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return PHPShark_AdminPageFramework_Registry::NAME;
    }
    static public function getFrameworkNameVersion() {
        return self::getFrameworkName() . ' ' . self::getFrameworkVersion();
    }
    }
    class PHPShark_AdminPageFramework_ArrayHandler extends PHPShark_AdminPageFramework_FrameworkUtility {
        public $aData = array();
