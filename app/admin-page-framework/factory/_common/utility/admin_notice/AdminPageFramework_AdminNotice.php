...
class PHPShark_AdminPageFramework_AdminNotice extends PHPShark_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'phpshark-plugin-settings-notice-message', 'phpshark-plugin-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new PHPShark_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
