...
class PHPShark_AdminPageFramework_AdminNotice___Script extends PHPShark_AdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.phpshark-plugin-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='phpshark-plugin-admin-notice-animation-container'></div>" );
