...
class PHPShark_AdminPageFramework_Debug_Base extends PHPShark_AdminPageFramework_FrameworkUtility {
    ...
    class PHPShark_AdminPageFramework_Debug_Log extends PHPShark_AdminPageFramework_Debug_Base {
    ...
    class PHPShark_AdminPageFramework_Debug extends PHPShark_AdminPageFramework_Debug_Log {
        ...
        static public function dumpArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('PHPShark_AdminPageFramework_Debug::' . __FUNCTION__, 'PHPShark_AdminPageFramework_Debug::dump()');
            PHPShark_AdminPageFramework_Debug::dump($asArray, $sFilePath);
        }
        static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
            self::showDeprecationNotice('PHPShark_AdminPageFramework_Debug::' . __FUNCTION__, 'PHPShark_AdminPageFramework_Debug::get()');
            return PHPShark_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
        }
        static public function logArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('PHPShark_AdminPageFramework_Debug::' . __FUNCTION__, 'PHPShark_AdminPageFramework_Debug::log()');
            PHPShark_AdminPageFramework_Debug::log($asArray, $sFilePath);
        }
        static public function getAsString($mValue) {
            self::showDeprecationNotice('PHPShark_AdminPageFramework_Debug::' . __FUNCTION__);
