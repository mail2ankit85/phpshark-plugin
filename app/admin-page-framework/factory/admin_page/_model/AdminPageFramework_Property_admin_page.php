...
class PHPShark_AdminPageFramework_Property_admin_page extends PHPShark_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'phpshark-plugin') {
        ...
        $GLOBALS['aPHPShark_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aPHPShark_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aPHPShark_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
