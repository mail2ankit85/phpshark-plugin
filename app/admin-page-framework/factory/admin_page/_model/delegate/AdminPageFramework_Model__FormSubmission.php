...
abstract class PHPShark_AdminPageFramework_Model__FormSubmission_Base extends PHPShark_AdminPageFramework_Form_Utility {
    ...
    class PHPShark_AdminPageFramework_Model__FormSubmission extends PHPShark_AdminPageFramework_Model__FormSubmission_Base {
        public $oFactory;
        public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
            $this->oFactory = $oFactory;
            $this->_handleFormData();
            new PHPShark_AdminPageFramework_Model__FormRedirectHandler($oFactory);
        }
        public function _handleFormData() {
            ...
            new PHPShark_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
