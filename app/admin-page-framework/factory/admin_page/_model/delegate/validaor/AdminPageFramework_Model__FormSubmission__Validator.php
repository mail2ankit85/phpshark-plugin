...
class PHPShark_AdminPageFramework_Model__FormSubmission__Validator_Base extends PHPShark_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    ...
    class PHPShark_AdminPageFramework_Model__FormSubmission__Validator extends PHPShark_AdminPageFramework_Model__FormSubmission__Validator_Base {
        public $oFactory;
        ...
        public function _replyToValidateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
            ...
            $_aClassNames = array('PHPShark_AdminPageFramework_Model__FormSubmission__Validator__Link', 'PHPShark_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'PHPShark_AdminPageFramework_Model__FormSubmission__Validator__Import', 'PHPShark_AdminPageFramework_Model__FormSubmission__Validator__Export', 'PHPShark_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'PHPShark_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'PHPShark_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'PHPShark_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
            ...
            try {
                ...
                $_oFormSubmissionFilter = new PHPShark_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
