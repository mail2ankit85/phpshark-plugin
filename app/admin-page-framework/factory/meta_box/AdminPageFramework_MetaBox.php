...
abstract class PHPShark_AdminPageFramework_MetaBox_Router extends PHPShark_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'phpshark-plugin') {
    ...
    abstract class PHPShark_AdminPageFramework_MetaBox_Model extends PHPShark_AdminPageFramework_MetaBox_Router {
        public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'phpshark-plugin') {
        ...
        public function _replyToGetSavedFormData() {
            $_oMetaData = new PHPShark_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
    ...
    abstract class PHPShark_AdminPageFramework_MetaBox_View extends PHPShark_AdminPageFramework_MetaBox_Model {
    ...
    abstract class PHPShark_AdminPageFramework_MetaBox_Controller extends PHPShark_AdminPageFramework_MetaBox_View {
    ...
    abstract class PHPShark_AdminPageFramework_MetaBox extends PHPShark_AdminPageFramework_MetaBox_Controller {
