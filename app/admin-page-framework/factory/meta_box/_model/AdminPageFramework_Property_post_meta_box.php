...
class PHPShark_AdminPageFramework_Property_post_meta_box extends PHPShark_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'edit_posts', $sTextDomain = 'phpshark-plugin', $sStructureType = 'post_meta_box') {
