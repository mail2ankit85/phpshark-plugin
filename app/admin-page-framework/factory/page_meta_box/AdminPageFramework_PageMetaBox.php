...
abstract class PHPShark_AdminPageFramework_PageMetaBox_Router extends PHPShark_AdminPageFramework_MetaBox_View {
    ...
    abstract class PHPShark_AdminPageFramework_PageMetaBox_Model extends PHPShark_AdminPageFramework_PageMetaBox_Router {
    ...
    abstract class PHPShark_AdminPageFramework_PageMetaBox_View extends PHPShark_AdminPageFramework_PageMetaBox_Model {
    }
    abstract class PHPShark_AdminPageFramework_PageMetaBox_Controller extends PHPShark_AdminPageFramework_PageMetaBox_View {
    ...
    abstract class PHPShark_AdminPageFramework_PageMetaBox extends PHPShark_AdminPageFramework_PageMetaBox_Controller {
        protected $_sStructureType = 'page_meta_box';
        public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'phpshark-plugin') {
