...
abstract class PHPShark_AdminPageFramework_TermMeta_Router extends PHPShark_AdminPageFramework_TaxonomyField_Controller {
    }
    abstract class PHPShark_AdminPageFramework_TermMeta_Model extends PHPShark_AdminPageFramework_TermMeta_Router {
        ...
        private function _getSavedTermMetas($iTermID, array $aFieldsets) {
            $_oMetaData = new PHPShark_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
    ...
    abstract class PHPShark_AdminPageFramework_TermMeta_View extends PHPShark_AdminPageFramework_TermMeta_Model {
    ...
    abstract class PHPShark_AdminPageFramework_TermMeta_Controller extends PHPShark_AdminPageFramework_TermMeta_View {
    }
    abstract class PHPShark_AdminPageFramework_TermMeta extends PHPShark_AdminPageFramework_TermMeta_Controller {
        protected $_sStructureType = 'term_meta';
        public function __construct($asTaxonomySlug, $sCapability = 'manage_options', $sTextDomain = 'phpshark-plugin') {
