...
abstract class PHPShark_AdminPageFramework_UserMeta_Router extends PHPShark_AdminPageFramework_Factory {
    ...
    abstract class PHPShark_AdminPageFramework_UserMeta_Model extends PHPShark_AdminPageFramework_UserMeta_Router {
        public function _replyToGetSavedFormData() {
            $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
            $_oMetaData = new PHPShark_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
    ...
    abstract class PHPShark_AdminPageFramework_UserMeta_View extends PHPShark_AdminPageFramework_UserMeta_Model {
    ...
    abstract class PHPShark_AdminPageFramework_UserMeta_Controller extends PHPShark_AdminPageFramework_UserMeta_View {
    ...
    abstract class PHPShark_AdminPageFramework_UserMeta extends PHPShark_AdminPageFramework_UserMeta_Controller {
        protected $_sStructureType = 'user_meta';
        public function __construct($sCapability = 'read', $sTextDomain = 'phpshark-plugin') {
