...
abstract class PHPShark_AdminPageFramework_Widget_Router extends PHPShark_AdminPageFramework_Factory {
    ...
    abstract class PHPShark_AdminPageFramework_Widget_Model extends PHPShark_AdminPageFramework_Widget_Router {
        ...
        public function _replyToRegisterWidget() {
            ...
            $GLOBALS['wp_widget_factory']->widgets[$this->oProp->sClassName] = new PHPShark_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
            $this->oProp->oWidget = $GLOBALS['wp_widget_factory']->widgets[$this->oProp->sClassName];
        }
    }
    abstract class PHPShark_AdminPageFramework_Widget_View extends PHPShark_AdminPageFramework_Widget_Model {
    ...
    abstract class PHPShark_AdminPageFramework_Widget_Controller extends PHPShark_AdminPageFramework_Widget_View {
    ...
    abstract class PHPShark_AdminPageFramework_Widget extends PHPShark_AdminPageFramework_Widget_Controller {
        protected $_sStructureType = 'widget';
        public function __construct() {
            $_sThisClassName = get_class($this);
            $_bAssumedAsWPWidget = 0 === func_num_args();
            $_aDefaults = array('', array(), 'edit_theme_options', 'phpshark-plugin');
