...
class PHPShark_AdminPageFramework_Property_widget extends PHPShark_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'phpshark-plugin', $sStructureType) {
