...
abstract class PHPShark_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('PHPShark_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new PHPShark_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
