...
class PHPShark_GitHubCustomFieldType extends PHPShark_AdminPageFramework_FieldType {
    ...
    protected function getField( $aField ) { 
        ...
        return 
            $aField['before_label']
            . "<div class='php-shark-input-label-container'>"        
                . $aField['before_input']
                . ( $aField['label'] && ! $aField['repeatable']
                    ? "<span class='php-shark-input-label-string' style='min-width:" . $this->getLengthSanitized( $aField['label_min_width'] ) . ";'>" . $aField['label'] . "</span>"
                    : "" 
                )
        ...
        private function _getButtonLabelByType( $sButtonType, $sUserName, $sValue ) {
            ...
            switch( $sButtonType ) {
                case 'follow': 
                    return sprintf( __( 'Follow @%1$s', 'php-shark' ), $sUserName );
                case 'watch':
                    return __( 'Watch', 'php-shark' );
                case 'star':
                    return __( 'Star', 'php-shark' );
                case 'fork':
                    return __( 'Fork', 'php-shark' );
                case 'issue':
                    return __( 'Issue', 'php-shark' );
                default:
                    return '';
            }                 
