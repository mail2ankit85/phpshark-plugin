...
jQuery( document ).ready( function(){
    ...
    jQuery( '.php-shark-checkbox-container-posttype[data-select_all_button]' ).each( function( iIndex ){
    ...
    jQuery( '.php-shark-checkbox-container-posttype[data-select_none_button]' ).each( function( iIndex ){
    ...
    jQuery( document ).on( 'change', '.php-shark-field-post_type_taxonomy .php-shark-field-posttype input[type="checkbox"]', function() {
        ...
        var _oField              = jQuery( this ).closest( '.php-shark-field-post_type_taxonomy' );
    ...
    jQuery( '.php-shark-field-post_type_taxonomy .php-shark-field-posttype input[type="checkbox"]:not(:checked)' ).each( function(){
    ...
    jQuery().registerPHPShark_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            oCloned.find( '.php-shark-field-posttype input[type="checkbox"]' )
                .prop( 'checked', false )
                .trigger( 'change' );         
...
.php-shark-field-post_type_taxonomy .select_all_button_container, 
.php-shark-field-post_type_taxonomy .select_none_button_container
{
...
.php-shark-field-post_type_taxonomy .select-taxonomy-terms-checkbox-container {
            ...
            return "<div class='select-taxonomy-terms-checkbox-container'>"
                    . "<label class='select-taxonomy-terms'>"
                        ...
                        . "<input " . $this->getAttributes( $_aCheckboxAttributes ) . " />"
                            . __( 'Select taxonomy terms.', 'php-shark-loader' )
                    . "</label>"
                . "</div>";
