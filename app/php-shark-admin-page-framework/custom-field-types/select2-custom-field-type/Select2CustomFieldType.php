...
"jQuery( document ).ready( function(){
    ...
    var _initializeSelect2 = function( oNode ) {
        ...
        if ( _aOptions[ 'width' ] && 'auto' !== _aOptions[ 'width' ] ) {
            var _oFieldContainer = _oSelect2Target.closest( '.php-shark-field-select2' );
            _oFieldContainer.css( 'width', _aOptions[ 'width' ] );
            _oFieldContainer.children( '.php-shark-select-label' )
                .css( 'width', '100%' );
            _oFieldContainer.children( '.php-shark-select-label' )
                .children( 'label' )
                .children( '.php-shark-input-container' )
                .css( 'width', '100%' );
            _aOptions[ 'width' ] = '100%';
        }
        ...
        if ( _aOptions[ 'search_callback' ] ) {
             ...
             * Set initial values.
             */
            var _oInputForEncoded = _oSelect2Target.closest( '.php-shark-field' )
            ...
            _oSelect2Target.on( 'change', function( event ){
                ...
                jQuery( this ).closest( '.php-shark-field' )
                    .children( 'input[data-encoded]' ).first()
    ...
    protected function getStyles() {
        return "
.php-shark-field-select2 .select2-container {     
    min-width: 200px;
    width: auto;
}

.php-shark-field-select2 {
    max-width: 96%;
}

/* Make a room for repeatable buttons */
.repeatable .php-shark-field-select2 > .php-shark-select-label > label > .php-shark-input-container {
    max-width: 84%;
}
