...
class PHPShark_AdminPageFramework_Message {
    ...
    protected $_sTextDomain = 'php-shark';
    static private $_aInstancesByTextDomain = array();
    public static function getInstance($sTextDomain = 'php-shark') {
    ...
    public static function instantiate($sTextDomain = 'php-shark') {
        return self::getInstance($sTextDomain);
    }
    public function __construct($sTextDomain = 'php-shark') {
    ...
    private function ___doDummy() {
        __('The options have been updated.', 'php-shark');
        __('The options have been cleared.', 'php-shark');
        __('Export', 'php-shark');
        __('Export Options', 'php-shark');
        __('Import', 'php-shark');
        __('Import Options', 'php-shark');
        __('Submit', 'php-shark');
        __('An error occurred while uploading the import file.', 'php-shark');
        __('The uploaded file type is not supported: %1$s', 'php-shark');
        __('Could not load the importing data.', 'php-shark');
        __('The uploaded file has been imported.', 'php-shark');
        __('No data could be imported.', 'php-shark');
        __('Upload Image', 'php-shark');
        __('Use This Image', 'php-shark');
        __('Insert from URL', 'php-shark');
        __('Are you sure you want to reset the options?', 'php-shark');
        __('Please confirm your action.', 'php-shark');
        __('The specified options have been deleted.', 'php-shark');
        __('A problem occurred while processing the form data. Please try again.', 'php-shark');
        __('Not all form fields could not be sent. Please check your server settings of PHP <code>max_input_vars</code> and consult the server administrator to increase the value. <code>max input vars</code>: %1$s. <code>$_POST</code> count: %2$s', 'php-shark');
        __('Is it okay to send the email?', 'php-shark');
        __('The email has been sent.', 'php-shark');
        __('The email has been scheduled.', 'php-shark');
        __('There was a problem sending the email', 'php-shark');
        __('Title', 'php-shark');
        __('Author', 'php-shark');
        __('Categories', 'php-shark');
        __('Tags', 'php-shark');
        __('Comments', 'php-shark');
        __('Date', 'php-shark');
        __('Show All', 'php-shark');
        __('Show All Authors', 'php-shark');
        __('Thank you for creating with', 'php-shark');
        __('and', 'php-shark');
        __('Settings', 'php-shark');
        __('Manage', 'php-shark');
        __('Select Image', 'php-shark');
        __('Upload File', 'php-shark');
        __('Use This File', 'php-shark');
        __('Select File', 'php-shark');
        __('Remove Value', 'php-shark');
        __('Select All', 'php-shark');
        __('Select None', 'php-shark');
        __('No term found.', 'php-shark');
        __('Select', 'php-shark');
        __('Insert', 'php-shark');
        __('Use This', 'php-shark');
        __('Return to Library', 'php-shark');
        __('%1$s queries in %2$s seconds.', 'php-shark');
        __('%1$s out of %2$s MB (%3$s) memory used.', 'php-shark');
        __('Peak memory usage %1$s MB.', 'php-shark');
        __('Initial memory usage  %1$s MB.', 'php-shark');
        __('The allowed maximum number of fields is {0}.', 'php-shark');
        __('The allowed minimum number of fields is {0}.', 'php-shark');
        __('Add', 'php-shark');
        __('Remove', 'php-shark');
        __('The allowed maximum number of sections is {0}', 'php-shark');
        __('The allowed minimum number of sections is {0}', 'php-shark');
        __('Add Section', 'php-shark');
        __('Remove Section', 'php-shark');
        __('Toggle All', 'php-shark');
        __('Toggle all collapsible sections', 'php-shark');
        __('Reset', 'php-shark');
        __('Yes', 'php-shark');
        __('No', 'php-shark');
        __('On', 'php-shark');
        __('Off', 'php-shark');
        __('Enabled', 'php-shark');
        __('Disabled', 'php-shark');
        __('Supported', 'php-shark');
        __('Not Supported', 'php-shark');
        __('Functional', 'php-shark');
        __('Not Functional', 'php-shark');
        __('Too Long', 'php-shark');
        __('Acceptable', 'php-shark');
        __('No log found.', 'php-shark');
        __('The method is called too early: %1$s', 'php-shark');
        __('Debug Info', 'php-shark');
        __('Click here to expand to view the contents.', 'php-shark');
        __('Click here to collapse the contents.', 'php-shark');
        __('Loading...', 'php-shark');
        __('Please enable JavaScript for better user experience.', 'php-shark');
        __('Debug', 'php-shark');
        __('Field Arguments', 'php-shark');
        __('This information will be disabled when <code>WP_DEBUG</code> is set to <code>false</code> in <code>wp-config.php</code>.', 'php-shark');
        __('Section Arguments', 'php-shark');
        __('The ability to repeat sections is disabled.', 'php-shark');
        __('The ability to repeat fields is disabled.', 'php-shark');
        __('Warning.', 'php-shark');
    }
    }
