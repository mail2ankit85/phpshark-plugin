...
abstract class PHPShark_AdminPageFramework_Form_View___Attribute_Base extends PHPShark_AdminPageFramework_Form_Utility {
    ...
    class PHPShark_AdminPageFramework_Form_View___Attribute_Field extends PHPShark_AdminPageFramework_Form_View___Attribute_FieldContainer_Base {
        ...
        protected function _getAttributes() {
            $_sFieldTypeSelector = $this->getAOrB($this->aArguments['type'], " php-shark-field-{$this->aArguments['type']}", '');
            ...
            return array('id' => $this->aArguments['_field_container_id'], 'data-type' => $this->aArguments['type'], 'class' => "php-shark-field{$_sFieldTypeSelector}{$_sNestedFieldSelector}{$_sMixedFieldSelector}{$_sChildFieldSelector}" . $this->getAOrB($this->aArguments['attributes']['disabled'], ' disabled', '') . $this->getAOrB($this->aArguments['_is_sub_field'], ' php-shark-subfield', ''));
        }
    }
