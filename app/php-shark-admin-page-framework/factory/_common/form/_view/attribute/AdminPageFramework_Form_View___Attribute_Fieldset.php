...
class PHPShark_AdminPageFramework_Form_View___Attribute_Fieldset extends PHPShark_AdminPageFramework_Form_View___Attribute_FieldContainer_Base {
    ...
    protected function _getAttributes() {
        return array('id' => $this->sContext . '-' . $this->aArguments['tag_id'], 'class' => implode(' ', array('php-shark-' . $this->sContext, $this->_getSelectorForChildFieldset())), 'data-field_id' => $this->aArguments['tag_id'], 'style' => $this->_getInlineCSS(),);
    }
