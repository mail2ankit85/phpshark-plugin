...
jQuery( document ).ready( function() {
    var _oButtonPlaceHolders = jQuery( '#{$sFieldsContainerID} > .php-shark-field.without-child-fields .repeatable-field-buttons' );
    ...
    /* Otherwise, insert the button element at the beginning of the field tag */
         ...
         */
        if ( ! jQuery( '#{$sFieldsContainerID} .php-shark-repeatable-field-buttons' ).length ) { 
            jQuery( '#{$sFieldsContainerID} > .php-shark-field.without-nested-fields' ).prepend( $_sSmallButtons );
        }
        /**
         * Support for nested fields.
         * For nested fields, add the buttons to the fields tag.
         */
        jQuery( '#{$sFieldsContainerID} > .php-shark-field.with-nested-fields' ).prepend( $_sNestedFieldsButtons );
        
        /**
         * Support for inline mixed fields.
         */
        // jQuery( '#{$sFieldsContainerID} > .php-shark-field.with-mixed-fields' ).prepend( $_sNestedFieldsButtons );
...
JAVASCRIPTS;
    ...
    private function ___getContainerAttributes($aArguments) {
        $_aContainerAttributes = array('class' => $this->getClassAttribute('php-shark-repeatable-field-buttons', !empty($aArguments['disabled']) ? 'disabled' : ''),);
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='php-shark-sortable-field-enabler-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
    }
    class PHPShark_AdminPageFramework_Form_View___Fieldset extends PHPShark_AdminPageFramework_Form_View___Fieldset_Base {
        ...
        private function _getChildFieldTitle($aFieldset) {
            ...
            $_oFieldTitle = new PHPShark_AdminPageFramework_Form_View___FieldTitle($aFieldset, array('php-shark-child-field-title'), $this->aOptions, $this->aErrors, $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
            return $_oFieldTitle->get();
        }
        ...
        private function _getExtras($aField, $iFieldsCount) {
            $_aOutput = array();
            $_oFieldDescription = new PHPShark_AdminPageFramework_Form_View___Description($aField['description'], 'php-shark-fields-description');
