...
class PHPShark_AdminPageFramework_Form_View__Resource__Head extends PHPShark_AdminPageFramework_FrameworkUtility {
    ...
    public function _replyToInsertRequiredInternalScripts() {
        ...
        echo "<script type='text/javascript' class='php-shark-form-script-required-in-head'>" . '/* <![CDATA[ */ ' . $this->_getScripts_RequiredInHead() . ' /* ]]> */' . "</script>";
    }
    private function _getScripts_RequiredInHead() {
        return 'document.write( "<style class=\'php-shark-js-embedded-internal-style\'>' . str_replace('\\n', '', esc_js($this->_getInternalCSS())) . '</style>" );';
    }
    ...
    private function _getScriptElementConcealerCSSRules() {
        return ".php-shark-form-js-on {visibility: hidden;}.widget .php-shark-form-js-on { visibility: visible; }";
    }
    }
