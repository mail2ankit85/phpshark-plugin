...
(function ( $ ) {
    ...
    $.fn.updatePHPShark_AdminPageFrameworkRepeatableFields = function( aSettings ) {
        ...
        var _oRepeatableButtons = $( nodeThis ).find( '.php-shark-repeatable-field-buttons' )
            .filter( function() {                                       
                return $( this ).closest( '.php-shark-fields' ).attr( 'id' ) === _sFieldsContainerID;  // Avoid dealing with nested field's elements.                
            });       
...
// @todo event.preventDefault();        
        ...
        var _sFieldID           = _oRepeatableAddButtons.first().closest( '.php-shark-field' ).attr( 'id' );
        var _nCurrentFieldCount = $( '#' + _sFieldsContainerID ).find( '.php-shark-field' )
            .filter( function() {                 
                return $( this ).closest( '.php-shark-fields' ).attr( 'id' ) === _sFieldsContainerID;  // Avoid dealing with nested field's elements.                
            })        
            .length;
    ...
    $.fn.addPHPShark_AdminPageFrameworkRepeatableField = function( sFieldContainerID ) {
        ...
        if ( 'undefined' === typeof sFieldContainerID ) {
            var sFieldContainerID = $( this ).closest( '.php-shark-field' ).attr( 'id' );
        }

        var nodeFieldContainer  = $( '#' + sFieldContainerID );
        var nodeNewField        = nodeFieldContainer.clone(); // clone without bind events.
        var nodeFieldsContainer = nodeFieldContainer.closest( '.php-shark-fields' );
        ...
        if ( ! _aOptions ) {     
            var _nodeButtonContainer = nodeFieldContainer.find( '.php-shark-repeatable-field-buttons' )
                .filter( function() {                 
                    return $( this ).closest( '.php-shark-fields' ).attr( 'id' ) === _sFieldsContainerID;  // Avoid dealing with nested field's elements.                
                })
                .first();
        ...
        var _oInnerFields       = nodeFieldsContainer.find( '.php-shark-field' ) 
                                    .filter( function() {                 
                                        return $( this ).closest( '.php-shark-fields' ).attr( 'id' ) === _sFieldsContainerID;  // Avoid dealing with nested field's elements.                
                                    });
        var _oRepeatableButtons = nodeFieldContainer.find( '.php-shark-repeatable-field-buttons' )
                                    .filter( function() {                 
                                        return $( this ).closest( '.php-shark-fields' ).attr( 'id' ) === _sFieldsContainerID;  // Avoid dealing with nested field's elements.                
                                    }); 
        ...
        $( nodeNewField ).find( '.php-shark-field' ).addBack().trigger( 
            'php-shark_repeated_field', 
            [ 
                0, // call type, 0 : repeatable fields, 1: repeatable sections
                jQuery( nodeNewField ).closest( '.php-shark-fields' )    // model container
            ]
        );
        ...
        var nodeRemoveButtons = nodeFieldsContainer
            ...
            .filter( function() {                      
                return $( this ).closest( '.php-shark-fields' ).attr( 'id' ) === _sFieldsContainerID;                
            })
        ...
        nodeFieldsContainer.children( '.php-shark-field' ).children( '.delimiter' ).show().last().hide();
        ...
        var _incrementFieldAttributes = function( oElement, oFieldsContainer ) {
            ...
            oElement.find( '.php-shark-field,.php-shark-fields,.php-shark-fieldset' ).incrementAttributes(
    ...
    $.fn.removePHPShark_AdminPageFrameworkRepeatableField = function() {
        ...
        var nodeFieldContainer  = $( this ).closest( '.php-shark-field' );
        var nodeFieldsContainer = $( this ).closest( '.php-shark-fields' );
        var _sFieldsContainerID = nodeFieldsContainer.attr( 'id' );
        var _aOptions = nodeFieldsContainer.data( 'repeatable' );
