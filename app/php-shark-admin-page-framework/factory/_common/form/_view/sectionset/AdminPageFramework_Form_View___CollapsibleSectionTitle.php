...
class PHPShark_AdminPageFramework_Form_View___Section_Base extends PHPShark_AdminPageFramework_Form_Base {
    ...
    class PHPShark_AdminPageFramework_Form_View___SectionTitle extends PHPShark_AdminPageFramework_Form_View___Section_Base {
        ...
        private function _getCollapseButton($aCollapsible) {
            ...
            return $this->getAOrB('button' === $this->getElement($aCollapsible, 'type', 'box'), "<span class='php-shark-collapsible-button php-shark-collapsible-button-expand' title='{$_sExpand}'>&#9658;</span>" . "<span class='php-shark-collapsible-button php-shark-collapsible-button-collapse' title='{$_sCollapse}'>&#9660;</span>", '');
        }
    ...
    class PHPShark_AdminPageFramework_Form_View___CollapsibleSectionTitle extends PHPShark_AdminPageFramework_Form_View___SectionTitle {
        ...
        private function _getCollapsibleSectionTitleBlock(array $aCollapsible, $sContainer = 'sections', $iSectionIndex = null) {
            ...
            return $this->_getCollapsibleSectionsEnablerScript() . "<div " . $this->getAttributes(array('id' => $_sSectionTitleTagID, 'class' => $this->getClassAttribute('php-shark-section-title', $this->getAOrB('box' === $aCollapsible['type'], 'accordion-section-title', ''), 'php-shark-collapsible-title', $this->getAOrB('sections' === $aCollapsible['container'], 'php-shark-collapsible-sections-title', 'php-shark-collapsible-section-title'), $this->getAOrB($aCollapsible['is_collapsed'], 'collapsed', ''), 'php-shark-collapsible-type-' . $aCollapsible['type']),) + $this->getDataAttributeArray($aCollapsible)) . ">" . $_sSectionTitle . "</div>";
        }
