...
class PHPShark_AdminPageFramework_Form_View___FieldTitle extends PHPShark_AdminPageFramework_Form_Utility {
    ...
    public function get() {
        ...
        $_aLabelAttributes = array('class' => $this->getClassAttribute('php-shark-field-title', $this->aClassSelectors), 'for' => $_oInputTagIDGenerator->get(),);
