...
abstract class PHPShark_AdminPageFramework_FieldType_Base extends PHPShark_AdminPageFramework_Form_Utility {
    ...
    class PHPShark_AdminPageFramework_FieldType_color extends PHPShark_AdminPageFramework_FieldType {
        ...
        protected function getStyles() {
            return ".repeatable .colorpicker {display: inline;}.php-shark-field-color .wp-picker-container {vertical-align: middle;}.php-shark-field-color .ui-widget-content {border: none;background: none;color: transparent;}.php-shark-field-color .ui-slider-vertical {width: inherit;height: auto;margin-top: -11px;}.php-shark-field-color .php-shark-repeatable-field-buttons {margin-top: 0;}.php-shark-field-color .wp-color-result {margin: 3px;}";
        }
        protected function getScripts() {
...
registerPHPShark_AdminPageFrameworkColorPickerField = function( osTragetInput, aOptions ) {
    ...
    var _aDefaults = {
        ...
        change: function( event, ui ){
            jQuery( this ).trigger( 
                'php-shark_field_type_color_changed',
        ...
        clear: function( event, ui ) {
            jQuery( this ).trigger(
                'php-shark_field_type_color_cleared',
...
JAVASCRIPTS;
        ...
        protected function getField($aField) {
            ...
            return $aField['before_label'] . "<div class='php-shark-input-label-container'>" . "<label for='{$aField['input_id']}'>" . $aField['before_input'] . ($aField['label'] && !$aField['repeatable'] ? "<span " . $this->getLabelContainerAttributes($aField, 'php-shark-input-label-string') . ">" . $aField['label'] . "</span>" : "") . "<input " . $this->getAttributes($aField['attributes']) . " />" . $aField['after_input'] . "<div class='repeatable-field-buttons'></div>" . "</label>" . "<div class='colorpicker' id='color_{$aField['input_id']}'></div>" . $this->_getColorPickerEnablerScript("{$aField['input_id']}") . "</div>" . $aField['after_label'];
        }
