...
class PHPShark_AdminPageFramework_FieldType_submit extends PHPShark_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".php-shark-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'php-shark-input-label-container' . ' php-shark-input-button-container' . ' php-shark-input-container',);
    }
