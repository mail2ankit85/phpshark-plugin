...
class PHPShark_AdminPageFramework_FieldType_import extends PHPShark_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".php-shark-field-import input {margin-right: 0.5em;}.php-shark-field-import label,.form-table td fieldset.php-shark-fieldset .php-shark-field-import label { display: inline; }";
    }
