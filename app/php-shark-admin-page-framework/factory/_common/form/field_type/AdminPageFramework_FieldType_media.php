...
jQuery( document ).ready( function(){
    ...
    jQuery().registerPHPShark_AdminPageFrameworkCallbacks( { 
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            // Bind the event.
            var _oFieldContainer = oCloned.closest( '.php-shark-field' );
            ...
            if ( typeof( _oImage ) !== 'undefined'  ) {
                ...
                _oCustomImageUploader.state().get( 'selection' ).each( function( oAttachment, iIndex ) {
                    ...
                    var _oFieldContainer    = 'undefined' === typeof _oNewField 
                        ? jQuery( '#' + sInputID ).closest( '.php-shark-field' ) 
                        : _oNewField;
...
removeInputValuesForImage = function( oElem ) {
    ...
    var _oImageInput = jQuery( oElem ).closest( '.php-shark-field' ).find( '.image-field input' );                  
    if ( _oImageInput.length <= 0 )  {
        return;
    }
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".php-shark-field .image_preview {border: none; clear: both; margin-top: 0.4em;margin-bottom: 0.8em;display: block; max-width: 100%;height: auto; width: inherit;} .php-shark-field .image_preview img { display: block;height: auto; max-width: 100%;}.widget .php-shark-field .image_preview {max-width: 100%;}@media only screen and ( max-width: 1200px ) {.php-shark-field .image_preview {max-width: 600px;} } @media only screen and ( max-width: 900px ) {.php-shark-field .image_preview {max-width: 440px;}}@media only screen and ( max-width: 600px ) {.php-shark-field .image_preview {max-width: 300px;}} @media only screen and ( max-width: 480px ) {.php-shark-field .image_preview {max-width: 240px;}}@media only screen and ( min-width: 1200px ) {.php-shark-field .image_preview {max-width: 600px;}}.php-shark-field-image input {margin-right: 0.5em;vertical-align: middle;}.select_image.button.button-small,.remove_image.button.button-small{ vertical-align: middle;}.remove_image.button.button-small {margin-left: 0.2em;}@media screen and (max-width: 782px) {.php-shark-field-image input {margin: 0.5em 0.5em 0.5em 0;}}";
    }
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='php-shark-image-uploader-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
    }
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='php-shark-{$sType}-remove-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
    }
...
JAVASCRIPTS;
            ...
            return <<<JAVASCRIPTS
                ...
                removeInputValuesForMedia = function( oElem ) {
                    ...
                    var _oImageInput = jQuery( oElem ).closest( '.php-shark-field' ).find( '.media-field input' );                  
                    if ( _oImageInput.length <= 0 )  {
                        return;
                    }
...
JAVASCRIPTS;
            return "<script type='text/javascript' class='php-shark-media-uploader-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
        }
