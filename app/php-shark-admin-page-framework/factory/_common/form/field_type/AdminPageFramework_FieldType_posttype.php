...
JAVASCRIPTS;
    ...
    private function _getSelectButtonClassSelectors(array $aFieldTypeSlugs, $sDataAttribute = 'select_all_button') {
        ...
        foreach ($aFieldTypeSlugs as $_sSlug) {
            ...
            $_aClassSelectors[] = '.php-shark-checkbox-container-' . $_sSlug . "[data-{$sDataAttribute}]";
        }
        return implode(',', $_aClassSelectors);
    }
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.php-shark-checkbox-label {margin-top: 0.1em;}.php-shark-field input[type='checkbox' ] {margin-right: 0.5em;} .php-shark-field-checkbox .php-shark-input-label-container {padding-right: 1em;}.php-shark-field-checkbox .php-shark-input-label-string{display: inline; }";
    }
    ...
    class PHPShark_AdminPageFramework_FieldType_posttype extends PHPShark_AdminPageFramework_FieldType_checkbox {
        ...
        protected function getStyles() {
            ...
            return $_sParentStyles . ".php-shark-field input[type='checkbox'] {margin-right: 0.5em;} .php-shark-field-posttype .php-shark-input-label-container {padding-right: 1em;}";
        }
        protected function getField($aField) {
