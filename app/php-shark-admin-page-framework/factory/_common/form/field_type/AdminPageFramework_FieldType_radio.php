...
class PHPShark_AdminPageFramework_FieldType_radio extends PHPShark_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".php-shark-field input[type='radio'] {margin-right: 0.5em;} .php-shark-field-radio .php-shark-input-label-container {padding-right: 1em;} .php-shark-field-radio .php-shark-input-container {display: inline;} .php-shark-field-radio .php-shark-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.php-shark-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
