...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".php-shark-field .taxonomy-checklist li { margin: 8px 0 8px 20px; }.php-shark-field div.taxonomy-checklist {padding: 8px 0 8px 10px;margin-bottom: 20px;}.php-shark-field .taxonomy-checklist ul {list-style-type: none;margin: 0;}.php-shark-field .taxonomy-checklist ul ul {margin-left: 1em;}.php-shark-field .taxonomy-checklist-label {white-space: nowrap; }.php-shark-field .tab-box-container.categorydiv {max-height: none;}.php-shark-field .tab-box-tab-text {display: inline-block;font-size: 13px;font-size: smaller;padding: 2px;}.php-shark-field .tab-box-tabs {line-height: 12px;margin-bottom: 0;}.php-shark-field .tab-box-tabs .tab-box-tab.active {display: inline;border-color: #dfdfdf #dfdfdf #fff;margin-bottom: 0px;padding-bottom: 4px;background-color: #fff;}.php-shark-field .tab-box-container { position: relative; width: 100%; clear: both;margin-bottom: 1em;}.php-shark-field .tab-box-tabs li a { color: #333; text-decoration: none; }.php-shark-field .tab-box-contents-container {padding: 0 0 0 1.8em;padding: 0.55em 0.5em 0.55em 1.8em;border: 1px solid #dfdfdf; background-color: #fff;}.php-shark-field .tab-box-contents { overflow: hidden; overflow-x: hidden; position: relative; top: -1px; height: 300px;}.php-shark-field .tab-box-content { display: none; overflow: auto; display: block; position: relative; overflow-x: hidden;}.php-shark-field .tab-box-content .taxonomychecklist {margin-right: 3.2em;}.php-shark-field .tab-box-content:target, .php-shark-field .tab-box-content:target, .php-shark-field .tab-box-content:target { display: block; }.php-shark-field .tab-box-content .select_all_button_container, .php-shark-field .tab-box-content .select_none_button_container{display: inline-block;margin-top: 0.8em;}.php-shark-field .taxonomychecklist .children {margin-top: 6px;margin-left: 1em;}";
    }
