...
class PHPShark_AdminPageFramework_View__PageRenderer__InPageTabs extends PHPShark_AdminPageFramework_FrameworkUtility {
    ...
    private function _getOutput($aInPageTabs, $sCurrentPageSlug, $sTag) {
        ...
        if (!$_aPage['show_in_page_tabs']) {
            return $this->getElement($aInPageTabs, array($_sCurrentTabSlug, 'title')) ? "<{$_sTag} class='php-shark-in-page-tab-title'>" . $aInPageTabs[$_sCurrentTabSlug]['title'] . "</{$_sTag}>" : "";
        }
    ...
    private function _getInPageTabNavigationBar(array $aTabs, $sActiveTab, $sCurrentPageSlug, $sTag) {
        ...
        return $_sTabBar ? "<div class='php-shark-in-page-tab'>" . $_sTabBar . "</div>" : '';
    }
