...
abstract class PHPShark_AdminPageFramework_MetaBox_Router extends PHPShark_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'php-shark') {
