...
abstract class PHPShark_AdminPageFramework_PostType_Router extends PHPShark_AdminPageFramework_Factory {
    ...
    abstract class PHPShark_AdminPageFramework_PostType_View extends PHPShark_AdminPageFramework_PostType_Model {
        ...
        public function _replyToPrintStyle() {
            ...
            if (!empty($this->oProp->sStyle)) {
                echo "<style type='text/css' id='php-shark-style-post-type'>" . $this->oProp->sStyle . "</style>";
            }
        }
    ...
    abstract class PHPShark_AdminPageFramework_PostType extends PHPShark_AdminPageFramework_PostType_Controller {
        ...
        public function __construct($sPostType, $aArguments = array(), $sCallerPath = null, $sTextDomain = 'php-shark') {
            if (empty($sPostType)) {
                return;
            }
